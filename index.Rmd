...
By doing appropriate pre-processing and using a random forest model we were able to achieve **99.6% accuracy on a self-created testing dataset, and 100% accuracy on the assigned 20-observation test dataset.**
...
```
## Model, Out-Of-Sample Error Estimation
...
print(fit1)
```
**Estimated Out-Of-Sample Error Rate: Varies between 0.39%-0.51% on each run**
